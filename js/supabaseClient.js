  ...
  return '<div style="min-height:100vh;display:flex;align-items:center;justify-content:center;padding:24px;background:var(--bg)">'+
    '<div style="width:100%;max-width:380px">'+
      ...
      '<form class="card" autocomplete="on" onsubmit="event.preventDefault();formaSubmitAuth()">'+
        ...
        '<button type="submit" class="press" '+disabled+' style="width:100%;background:var(--blue);border:none;color:#fff;border-radius:11px;padding:13px;font-size:14px;font-weight:900;cursor:pointer;font-family:inherit;margin-bottom:10px">'+(a.loading?'<span style="display:inline-flex;align-items:center;gap:4px"><span class="typing-dot" style="background:#fff"></span><span class="typing-dot" style="background:#fff"></span><span class="typing-dot" style="background:#fff"></span></span>':isSignup?'Create account':'Sign in')+'</button>'+
