...
function tourSteps(){
  return [
    ...
    {view:'log',selector:'#sugtip-2',title:'Recommendations while you train',text:'When your history shows a clear pattern, I’ll explain what to do next before you log the set.',example:'You averaged 9 reps at 75 lbs across 3 sessions. I’d recommend adding 5 lbs.'},
